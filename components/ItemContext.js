...
function useItemContext () {
    const initialState = [{user: 0, id: 1, name: 'Apple Earphones', img:'https://res.cloudinary.com/prnkdslv/image/upload/v1633503659/TrashOrTreasure/ItemImages/image0_bsrlx6.jpg', location: 'Champaign',
    ...
    {user: 0, id: 2, name: 'Pink Floyd CD Collection', img:'https://res.cloudinary.com/prnkdslv/image/upload/v1634894314/TrashOrTreasure/ItemImages/ghoq4efmiel31_g9z8ji.jpg', location: 'Rantoul',
    ...
    {user: 0, id: 3, name: 'Standing Fan', img:'https://res.cloudinary.com/prnkdslv/image/upload/v1633504706/TrashOrTreasure/ItemImages/image0_amj6ro.jpg', location: 'Urbana',
    ...
    {user: 0, id: 4, name: 'Chinaware set', img:'https://res.cloudinary.com/prnkdslv/image/upload/v1634894314/TrashOrTreasure/ItemImages/e832b83dff635ddceaadb43817b24e85_s8dfnj.jpg', location: 'Champaign',
    ...
    {user: 0, id: 5, name: 'Xbox Controller', img:'https://res.cloudinary.com/prnkdslv/image/upload/v1633503650/TrashOrTreasure/ItemImages/IMG_5159_pycavk.jpg', location: 'Bloomington',
    ...
    {user: 0, id: 6, name: 'Bicycle lock', img:'https://res.cloudinary.com/prnkdslv/image/upload/v1634894314/TrashOrTreasure/ItemImages/4124fdbc3711e624fe9d2bbdfaf93f52_ip8nqp.jpg', location: 'Urbana',
    ...
    {user: 0, id: 7, name: 'Queen sized Bed with mattress and 2 pillows', img:'https://res.cloudinary.com/prnkdslv/image/upload/v1634828218/TrashOrTreasure/itemImages/n6b9mzzxkvmfyo8eym0e.jpg', location: 'Springfield',
    ...
    {user: 0, id: 8, name: 'Used Textbooks', img:'https://res.cloudinary.com/prnkdslv/image/upload/v1634894316/TrashOrTreasure/ItemImages/textbooks_z373qh.jpg', location: 'Bloomington',
    ...
    {user: 0, id: 9, name: 'Honda 70cc Bike', img:'https://res.cloudinary.com/prnkdslv/image/upload/v1634827571/TrashOrTreasure/itemImages/wcaqwsqvi5lx549c2um0.jpg', location: 'Decatur',
    ...
    {user: 0, id: 10, name: 'Old sofa', img:'https://res.cloudinary.com/prnkdslv/image/upload/v1634826284/TrashOrTreasure/itemImages/wzp2zasjoquuic0c7zhz.jpg', location: 'Champaign',
