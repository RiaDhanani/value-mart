    ...
    return (
        <div className={LandingPageStyles.landingPageSidebar}>
            <div className={LandingPageStyles.landingPageSidebarContent}>
                ...
                {user ? <Button text={'List Your Items'} onClick={() => setShowModal(true)}/> : <Button text={'List Your Items'} onClick={() => setShowLoginPromptModal(true)}/>}
                <Link legacyBehavior href="/browse"><a><Button text={'View Items'}/></a></Link>
